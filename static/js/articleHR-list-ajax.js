...
function dialogclose() {
 ...
 function ajax() {
            ...
            postJSON('/api/getaccountheadhunters', {"page": page, "pagesize":pagesize,  "id" : id , "phone": phone ,}, function (result) {
                ...
                for (var j = 0; j < result.data.length; j++) {
                    ...
                    listuse1.push({
                        ...
                        editurl: 'article-editHR.html?id=' + result.data[j].id,
                        team: 'mytoudui.html?userid=' + userid,
                    });
                }
